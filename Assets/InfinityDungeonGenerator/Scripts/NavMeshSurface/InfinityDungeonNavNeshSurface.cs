...
public class InfinityDungeonNavMeshSurface : MonoBehaviour
{
	...
	{
        Debug.Log("GenInfinityDungeon llamado. Parámetros: " +
       $"groundTransforamX={groundTransforamX}, groundTransforamZ={groundTransforamZ}, canReplacePlayerPosition={canReplacePlayerPosition}, " +
       $"entranceDoorPlaceI={entranceDoorPlaceI}, entranceDoorPlaceJ={entranceDoorPlaceJ}, entranceDoorPlace={entranceDoorPlace}, " +
       $"pastRSizeI={pastRSizeI}, pastRSizeJ={pastRSizeJ}");
